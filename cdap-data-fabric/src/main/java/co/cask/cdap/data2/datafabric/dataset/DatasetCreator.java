...
/**
 * Creates {@link Dataset}s directly using {@link DatasetSpecification}.
 */
...
public class DatasetCreator {
  ...
  @Inject
  public DatasetCreator(DatasetDefinitionRegistryFactory registryFactory) {
    this.registryFactory = registryFactory;
  }

  public <T extends Dataset> T create(
    ...
    return (T) type.getDataset(DatasetContext.from(namespace.getId()), meta.getSpec(), arguments);
  }

  public <T extends Dataset> T create(Id.Namespace namespace, DatasetMeta meta) throws IOException {
    return create(namespace, meta, null, null, null);
  }
