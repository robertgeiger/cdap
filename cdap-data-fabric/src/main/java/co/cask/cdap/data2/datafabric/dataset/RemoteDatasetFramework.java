...
public class RemoteDatasetFramework implements DatasetFramework {
  ...
  @Inject
  public RemoteDatasetFramework(final DiscoveryServiceClient discoveryClient, DatasetCreator creator) {
  ...
  public <T extends DatasetAdmin> T getAdmin(Id.DatasetInstance datasetInstanceId,
    ...
    DatasetType type = creator.getDatasetType(instanceInfo.getType(), parentClassLoader, classLoaderProvider);
  ...
  public <T extends Dataset> T getDataset(
    ...
    return (T) creator.create(
      datasetInstanceId.getNamespace(), instanceInfo, classLoaderProvider, classLoader, arguments);
  }
  ...
  public <T extends DatasetType> T getDatasetType(DatasetTypeMeta implementationInfo,
    ...
    return creator.getDatasetType(implementationInfo, classLoader, classLoaderProvider);
  }
}
