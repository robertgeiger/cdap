...
public class PreferencesHttpHandler extends AbstractAppFabricHttpHandler {
  ...
  @Inject
  public PreferencesHttpHandler(PreferencesStore preferencesStore, Store store, NamespaceStore nsStore) {
  ...
  public void getNamespacePrefs(HttpRequest request, HttpResponder responder,
    ...
    throws Exception {
    if (nsStore.getNamespace(Id.Namespace.from(namespace)) == null) {
