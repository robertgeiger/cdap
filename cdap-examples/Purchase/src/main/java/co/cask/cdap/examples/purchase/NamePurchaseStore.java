 ...
 */
public class NamePurchaseStore extends AbstractFlowlet {

  @UseDataSet("named_purchases")
  private ObjectMappedTable<Purchase> store;
  private Metrics metrics; // Declare the custom metrics

  private static final Logger LOG = LoggerFactory.getLogger(NamePurchaseStore.class);
  ...
  public void process(Purchase purchase) {
    ...
    store.write(purchase.getCustomer(), purchase);
  }
