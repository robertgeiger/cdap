 ...
 */
public class ExploreDatasetManager {
  private static final Logger LOG = LoggerFactory.getLogger(ExploreDatasetManager.class);
  ...
  @Inject
  public ExploreDatasetManager(ExploreService exploreService,
